# -*- coding: utf-8 -*-
"""Demo137_Inceptionism_CustomModel.ipynb
...
layers = [base_model.get_layer('conv2d').output]
...
sample_image = get_image(url, 500)
dream_img = run_deep_dream_simple(img=sample_image, steps=300, step_size=0.1)
